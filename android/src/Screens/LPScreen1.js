    ...
    <View style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.productDetails}>
          ...
          <Text style={styles.detailValue}>Krishna Building Material</Text>
        </View>
        <Text style={styles.description}>
          It reduces dead load on structures due to light weight (2.6 kg, dimension: 230 mm X 110 mm X 70 mm). Due to high strength, practically no breakage during transport and use. Due to uniform size of bricks mortar required for joints and plaster reduces almost by 50%
        </Text>
      </View>
    </View>
  );
