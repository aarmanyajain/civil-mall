...
const TPScreen2 = () => {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../Screens/product2.jpg')} style={styles.image} />
      <View style={styles.detailsContainer}>
        <Text style={styles.name}>2nd Grade Red Bricks</Text>
        ...
        <View style={styles.productDetails}>
          ...
          <Text style={styles.detailValue}>Freshtech Company</Text>
        </View>
